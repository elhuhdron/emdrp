...
pwatkins, created Apr 17, 2015

xxx - currently no command line versions (need for this?).
xxx - some classmethod initializations can probably call into super? cleanup

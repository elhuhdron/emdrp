...
outdir=/Data/watkinspv/full_datasets/neon/mfergus32_K0057_ds3_run5/cubes
...
do
    ...
    echo "python -u ./emneon.py --data_config $fn --model_file /mnt/syn2/watkinspv/convnet_out/neon/mfergus32_K0057_ds3_run5/K0057-dsx3y3z1_xyz_$iter.prm --write_output $outdir/knossos$iter.conf --image_in_size 128 --test_range 200001 204160 -i ${card[$iter]}" > run_tmp.sh

    cp -f ~/gits/emdrp/scripts/shell/K0057_D31_dsx3y3z1-run5/EMdata-3class-32x32out-export-K0057-dsx3y3z1.ini $fn

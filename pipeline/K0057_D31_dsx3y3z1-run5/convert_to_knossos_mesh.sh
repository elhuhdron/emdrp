...
declare -a synin=("syn2" "syn" "syn" "syn2")
level=0
while [ $level -lt 4 ]
do
    echo processing ${thrs[$level]}

    python -u dpCubeIter.py --volume_range_beg 2 8 1 --volume_range_end 50 38 19 --overlap 0 0 0 --cube_size 6 6 6 --cmd "cp" --fileflags 0 0 --filepaths /mnt/${synin[$level]}/watkinspv/full_datasets/neon/mfergus32_K0057_ds3_run5/mesh_wtsh /mnt/ext/K0057_D31/cubes_dsx3y3z1/mag1 --fileprefixes K0057_D31_mag1 K0057_D31_mag1 --filepostfixes .clean_wtshA.$level.mesh.h5 .clean_wtshB.$level.mesh.h5 --filepaths-affixes 0 1 --no_volume_flags > tmp_out${level}_1.sh
    ...
    #nohup sh tmp_out${level}.sh >& tmp_K0057_D31_dsx3y3z1-run5-cp-mesh${level}.txt &

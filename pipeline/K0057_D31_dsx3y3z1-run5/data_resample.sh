...
python -u dpResample.py --srcfile /mnt/syn/datasets/raw/K0057_D31_dsx3y3z1.h5 --dataset data_mag_x3y3z1 --volume_range_beg 0 0 0 --volume_range_end 48 40 16 --overlap 0 0 0 --cube_size 8 8 8 --dpRes --resample-dims 1 1 1 --factor 4 --outfile /mnt/syn2/watkinspv/K0057_D31_dsx12y12z4.h5 --dataset-out data_mag_x12y12z4 --downsample-op median --right_remainder_size 640 640 512

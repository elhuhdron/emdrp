...
i = 1;
pdata(i).datah5 = '~/Data/ECS_tutorial/M0007_33_8x8x4chunks_at_x0016_y0017_z0000.h5';
pdata(i).chunk = [16 17 0];
pdata(i).skelin = '~/Data/ECS_tutorial/M0007_33_dense_skels.152.nml';
pdata(i).lblsh5 = '~/Data/ECS_tutorial/M0007_supervoxels.h5';
...
i = 2;
pdata(i).datah5 = '~/Data/ECS_tutorial/M0027_11_8x8x4chunks_at_x0012_y0014_z0002.h5';
pdata(i).chunk = [12 14 2];
pdata(i).skelin = '~/Data/ECS_tutorial/M0027_11_dense_skels.186.nml';
pdata(i).lblsh5 = '~/Data/ECS_tutorial/M0027_supervoxels.h5';
...
pdata(i).chunk = [16 17 0];
pdata(i).skelin = '~/Data/ECS_tutorial/M0007_33_dense_skels.152.nml';
pdata(i).lblsh5 = '~/Data/ECS_tutorial/M0007_supervoxels_agglo.h5';
...
pdata(i).chunk = [12 14 2];
pdata(i).skelin = '~/Data/ECS_tutorial/M0027_11_dense_skels.186.nml';
pdata(i).lblsh5 = '~/Data/ECS_tutorial/M0027_supervoxels_agglo.h5';
...
% save the results
save('~/Data/ECS_tutorial/vgg3pool64_ECS_full_run2_crop_interp','p','pdata','o');

...
# run on gpu-clone in ~/gits/emdrp/recon/python

# for this run, "prob pushes" were divided on two synolgies.
# 2 streams on gpu-clones 0 and 1 going to syn and syn2 respectively.
# 4 streams of gpu-clones 2-4 split half to syn and half to syn2.
# this allows for 2 streams per synology ethernet interface.

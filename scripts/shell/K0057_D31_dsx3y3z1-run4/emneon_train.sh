...
echo "nohup time python -u ./emneon.py -e 1 --data_config data/tmp_config/EMdata-3class-32x32out-rand-K0057-dsx3y3z1.ini --serialize 200 -s /home/$(whoami)/Data/convnet_out/test-model.prm -o /home/$(whoami)/Data/convnet_out/test-output.h5 --model_arch mfergus --train_range 100001 103200 --epoch_dstep 1400 1000 600 -i ${card[$cnt]} >& /home/$(whoami)/Data/convnet_out/test-emneon-out.txt &" > run_tmp.sh

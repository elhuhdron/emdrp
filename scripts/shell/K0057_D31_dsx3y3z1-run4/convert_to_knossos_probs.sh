...
do
    ...
    do
        ...
        python -u dpCubeIter.py --volume_range_beg ${chunk_range_beg_x[$cnt]} 8 1 --volume_range_end ${chunk_range_end_x[$cnt]} 38 19 --overlap 0 0 0 --cube_size 1 1 1 --cmd "python -u $HOME/gits/emdrp/recon/python/dpLoadh5.py --dataset ${types[$count]} --dtypeGray uint8 --dpL" --fileflags outraw srcfile --filepaths /mnt/ext/K0057_D31/cubes_dsx3y3z1/K0057_D31_mag1 /mnt/${synin[$cnt]}/watkinspv/full_datasets/neon/mfergus32_K0057_ds3_run4/probs --fileprefixes K0057_D31_mag1 K0057_D31_dsx3y3z1_probs --filepostfixes .${types[$count]}_probs.raw .h5 --filepaths-affixes 1 0 --filemodulators 1 1 1  6 6 6 > tmp_out_${types[$count]}_${chunk_range_beg_x[$cnt]}_${synin[$cnt]}.sh
    
        nohup sh tmp_out_${types[$count]}_${chunk_range_beg_x[$cnt]}_${synin[$cnt]}.sh >& tmp_K0057_D31_dsx3y3z1-run4-cp-prob_${types[$count]}_${chunk_range_beg_x[$cnt]}_${synin[$cnt]}.txt &

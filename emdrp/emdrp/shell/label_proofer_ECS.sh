...
#fnout=/Users/pwatkins/Downloads/K0057_bootstrapping/K0057_D31_dsx3y3z1_x4o96_y35o96_z3_proof.nrrd
#fnovl=/Users/pwatkins/Downloads/K0057_bootstrapping/K0057_D31_dsx3y3z1_x4o96_y35o96_z3_overlay.nrrd
size='384 384 160'
corners='64 64 32'
...
dpCleanLabels.py --inraw $fnout --size $size --fg-connectivity 3 --srcfile '' --outraw $fnovl --minpath 2 \
    --ECS-label 1 --minpath-skel --minpath-perc 1e6 --dpC
